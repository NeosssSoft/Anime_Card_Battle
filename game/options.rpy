...
init -1 python hide:
    ...
    style.default.font = "font/msdatafont.ttf"
    ...
    style.button.activate_sound = "sound/click/click.wav"
    style.imagemap.activate_sound = "sound/click/click.wav"

    ## Sonidos utilizados cuando se entra o sale del menú del juego.

    config.enter_sound = "sound/click/click.wav"
    config.exit_sound = "sound/click/click.wav"
    ...
    config.main_menu_music = "sound/menu/menu.mp3"
...
python early:
    config.save_directory = "Anime Card Battle-1441627189"
...
init python:
    ...
    build.directory_name = "Anime-Card-Battle-1.0"

    ## The name that's uses for executables - the program that users will run
    ## to start the game. For example, if this is 'mygame', then on Windows,
    ## users can click 'mygame.exe' to start the game.
    build.executable_name = "Anime Card Battle"
